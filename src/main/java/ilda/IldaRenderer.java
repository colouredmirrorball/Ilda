...
public class IldaRenderer extends PGraphics {
    ...
    /**
     * Returns the overwrite setting, whether the renderer keeps drawing on the same frame or if
     ...
     * Instead, the renderer will
     * keep writing on the same frame. This is useful for drawing applications where you want to
    ...
    /**
     * Currently saving is not implemented in the renderer, use writeFile() in the main ilda
     * class instead.
     *
    ...
    protected void ellipseImpl(float x, float y, float w, float h) {
        ...
        for (float i = 0; i < m + 1 + circleCorrection; i++) {
            float xpos = (float) (2 * (((x + w / 2 * (Math.sin(TWO_PI * i / m) + 1) + matrix.m03) *
                                        invWidth) - 0.5f));
            float ypos = (float) (2 * (((y + h / 2 * (Math.cos(TWO_PI * i / m) + 1) + matrix.m13) *
                                        invHeight) - 0.5f));
            float zpos = 0;
            int red = (int) (strokeR * 255);
            int green = (int) (strokeG * 255);
    ...
    public void applyMatrix(float n00, float n01, float n02, float n03, float n10, float n11,
        ...
        float n32, float n33) {
        this.applyMatrixImpl(n00, n01, n02, n03, n10, n11, n12, n13, n20, n21, n22, n23, n30, n31,
            n32, n33);
    }
    ...
    protected void applyMatrixImpl(float n00, float n01, float n02, float n03, float n10, float n11,
        float n12, float n13, float n20, float n21, float n22, float n23, float n30, float n31,
        float n32, float n33) {
        this.matrix.apply(n00, n01, n02, n03, n10, n11, n12, n13, n20, n21, n22, n23, n30, n31, n32,
            n33);
